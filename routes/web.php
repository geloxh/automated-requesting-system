<?php
   ...
   $approvalActions = ['submit', 'checker-approval', 'review-approval', 'process-approval', 'evaluation-approval', 'grant-approval'];
    ...
    if ($uri === '/approvals') {
        \App\Middleware\RoleMiddleware::requireAnyRole([1, 2, 3, 4, 5, 6, 7, 8, 9]); // extend for roles 4,5,6 as needed
