<div class="page-header">
    <h5>Employees</h5>
    <a href="/automated-requesting-system/public/employees/create" class="btn btn-primary btn-sm">+ Add Employee</a>
</div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <form method="POST" action="/automated-requesting-system/public/employees/<?= $e['id'] ?>/status">
                ...
                <td>
                    <div class="flex-row-center">
                        <a href="/automated-requesting-system/public/employees/edit/<?= $e['id'] ?>" class="btn btn-ghost btn-sm" title="Edit">
                            <i class="ti ti-edit"></i> Edit
                        </a>
                        
                        <?php if ($e['id'] != $_SESSION['user_id']): ?>
                        <form method="POST" action="/automated-requesting-system/public/employees/<?= $e['id'] ?>/delete"
