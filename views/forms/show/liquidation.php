...
<div class="form-card">
    ...
    <div class="form-grid g-3">
        <div class="form-group"><label>Advance Date</label><input type="text" value="<?= $ro('advance_date') ?>" readonly></div>
        <div class="form-group"><label>Advance Type</label><input type="text" value="<?= $ro('advance_type') ?>" readonly></div>
        <div class="form-group"><label>Advance Amount</label><input type="number" value="<?= $ro('advance_amount') ?>" readonly></div>
    </div>
</div>
...
<div class="form-card">
    ...
    <div class="form-grid g-4 mt-1">
        ...
        <div class="form-group"><label>Balance / Refund</label><input type="number" value="<?= $ro('balance') ?>" readonly></div>
